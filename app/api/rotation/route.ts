...
import { member, memberDeviceKey, rotationApproval, rotationJob, rotationKeyWrap, rotationProgress, rotationJobStatus } from "@/db/schema";
...
export async function PUT(request: Request) {
  ...
  const updates: Record<string, string> = { paused: "paused", resume: "active", complete: "completed", rollback: "rolled_back" };
